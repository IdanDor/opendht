...
unsafe extern "C" {
    ...
    pub fn dht_bootstrap(
        ...
        sa_count: libc::size_t,
        done_cb: extern "C" fn(c_bool, *mut oneshot::Sender<bool>),
        done_ptr: *mut oneshot::Sender<bool>,
    );

    pub fn serialize(
        dht: dht_t,
        cb: extern "C" fn(*const libc::c_uchar, libc::size_t, *mut Vec<u8>),
        buf: *mut Vec<u8>,
    );
    ...
    pub fn dht_get(
        ...
        get_cb: extern "C" fn(
            ...
            *const libc::size_t,
            libc::size_t,
            *mut mpsc::Sender<Vec<u8>>,
        ) -> c_bool,
        get_tx: *mut mpsc::Sender<Vec<u8>>,
        done_cb: extern "C" fn(c_bool, *mut mpsc::Sender<Vec<u8>>),
